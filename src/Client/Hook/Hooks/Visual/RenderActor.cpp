...
void RenderActorHook::callback(void *a1, void *a2, Actor *actor, Vec3<float> a4, Vec3<float> distanceFromCamera,
                               Vec2<float> *a6, void *a7) {
    // TODO: render hitboxes here?
...
void RenderActorHook::enableHook() {
    this->autoHook((void *) callback, (void **) &renderActorOriginal);
}
