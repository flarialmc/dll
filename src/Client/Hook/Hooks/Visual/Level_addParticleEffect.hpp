...
private:
    static void Level_addParticleEffectDetour(Level* level, ParticleType id, const Vec3<float>& pos, const Vec3<float>& dir, void* data, void* tag, bool isGlobal);

public:
    typedef void(__thiscall *addParticleEffectOriginal)(Level* level, ParticleType id, const Vec3<float>& pos, const Vec3<float>& dir, void* data, void* tag, bool isGlobal);
