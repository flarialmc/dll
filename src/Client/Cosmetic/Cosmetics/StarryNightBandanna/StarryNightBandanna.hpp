...
#include "Cosmetic/Cosmetics/FlarialBandanna/FlarialBandanna.hpp"

class StarryNightBandanna: public Cosmetic {
public:
    StarryNightBandanna(): Cosmetic("StarryNightBandanna", true, 7, 7)
    {
        Listen(this, Render3DEvent, &StarryNightBandanna::onRender3D)
    }
    ...
    void onRender3D(Render3DEvent& event)
    {
        ...
        Vec3<float> scale = Vec3<float>(0.24, 0.1875, 0);
        ...
        *event.screenContext->getColorHolder() = MCCColor(1.0f, 1.0f, 1.0f, 1.0f);
        ...
        t->vertexUV(v2.x, v2.y, v2.z, 1.f, 0.0f);
        t->vertexUV(v3.x, v3.y, v3.z, 1.f, 1.0f);
        ...
        MeshHelpers::renderMeshImmediately2(event.screenContext, t, MaterialUtils::getNametag(), this->texture);
