    ...
    void onRender(RenderEvent &event) override {
        ...
        if (SDK::currentScreen == "hud_screen") {
            ...
            if (SwapchainHook::queue != nullptr)
                FlarialGUI::CopyBitmap(SwapchainHook::D2D1Bitmaps[SwapchainHook::currentBitmap], &currentFrame);
            ...
            for (ID2D1Bitmap *frame: previousFrames) {
                D2D::context->DrawBitmap(frame, D2D1::RectF(0.f, 0.f, MC::windowSize.x, MC::windowSize.y), alpha,
