...
public:
    ...
    void SettingsRender() override {
        ...
        FlarialGUI::FlarialText(toggleX - Constraints::SpacingConstraint(0.15, textWidth) , toggleY, L"Text Scale", D2D1::ColorF(D2D1::ColorF::White), textWidth * 1.069f, textHeight, DWRITE_TEXT_ALIGNMENT_CENTER);
