...
public:
    ...
    HurtColor() : Module("Hurt Color", "chike wi!", "\\Flarial\\assets\\magnify.png", 'C') {
    ...
    virtual void DefaultConfig() override {
        ...
        if (settings.getSettingByName<float>("colorOpacity") == nullptr) settings.addSetting("colorOpacity", 1.0f);
