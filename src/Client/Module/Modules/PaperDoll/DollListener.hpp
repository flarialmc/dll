...
public:
    ...
    void onRender(RenderEvent& event) override {
        ...
        if(SDK::clientInstance->getTopScreenName() == "hud_screen" && module->settings.getSettingByName<bool>("enabled")->value || SDK::clientInstance->getTopScreenName() == "pause_screen" && module->settings.getSettingByName<bool>("enabled")->value) {
            ...
            if(!enabled && ModuleManager::getModule("ClickGUI")->settings.getSettingByName<bool>("enabled")->value && !ModuleManager::getModule("ArmorHUD")->settings.getSettingByName<bool>("enabled")->value) {
            ...
            if(ModuleManager::getModule("ArmorHUD")->settings.getSettingByName<bool>("enabled")->value) enabled = true;
