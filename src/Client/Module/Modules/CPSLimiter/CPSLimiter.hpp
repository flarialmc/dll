...
public:
    ...
    void SettingsRender() override {
        ...
        FlarialGUI::FlarialTextWithFont(toggleX, toggleY, L"Left", D2D1::ColorF(D2D1::ColorF::White), textWidth, textHeight, DWRITE_TEXT_ALIGNMENT_LEADING, Constraints::RelativeConstraint(0.12, "height", true));
        ...
        FlarialGUI::FlarialTextWithFont(toggleX, toggleY, L"Right", D2D1::ColorF(D2D1::ColorF::White), textWidth, textHeight, DWRITE_TEXT_ALIGNMENT_LEADING, Constraints::RelativeConstraint(0.12, "height", true));
