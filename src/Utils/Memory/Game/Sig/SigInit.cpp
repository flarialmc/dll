...
void SigInit::init2120() {
    ...
    ADD_SIG("Actor::getRuntimeIDComponent", "48 89 5C 24 ? 57 48 83 EC ? 48 8B DA BA 14 14 A1 3C");
    ...
    // Zoom
    ADD_SIG("Options::getSensitivity", "4C 8B 51 20 49 B9"); // wrong

    // Fullbright
    ADD_SIG("Options::getGamma", "? ? ? ? ? ? ? ? ? ? ? 48 8D 54 24 ? 48 8B 01 48 8B 40 ? 74 ? 41 B8 ? ? ? ? FF 15 ? ? ? ? 48 8B 10 48 85 D2 74 ? 48 8B 42 ? 48 8B 88 ? ? ? ? 48 85 C9 74 ? E8 ? ? ? ? 48 83 C4 ? C3 F3 0F 10 42 ? 48 83 C4 ? C3 41 B8 ? ? ? ? FF 15 ? ? ? ? 48 8B 10 48 85 D2 75 ? E8 ? ? ? ? CC E8 ? ? ? ? CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC F3 0F 11 4C 24"); // wrong

    // HurtColor
    ADD_SIG("HurtColor", "E8 ? ? ? ? E9 ? ? ? ? 8B 43 ? 48 8D 54 24");

    // Block outline
    ADD_SIG("blockHighlightColor", "? ? ? ? 0F 11 45 ? 0F 11 00 C6 40 10 ? 45 38 96"); // wrong
...
void SigInit::init2040() {
    ...
    ADD_SIG("Actor::getRuntimeIDComponent", "40 53 48 83 EC 20 48 8B DA BA 14 14 A1 3C");
