...
void SigInit::init21100() {
    Logger::debug("[Signatures] Loading sigs for 1.21.10X");
    ...
    // someone check if these are the correct sigs cuz i swear they are but at the same time im an idiot
...
void SigInit::init2140() {
    ...
    ADD_SIG("Dimension::getBrightnessDependentFogColor", "41 0F 10 00 48 8B C2 0F");
    ...
    ADD_SIG("Options::getSensitivity", "48 83 EC 18 48 8B 41 08 4C 8B C9");
    ...
    DEPRECATE_SIG("Actor::getOnGroundFlagComponent");
}
...
void SigInit::init2030() {
    ...
    // Nick
    ADD_SIG("Actor::setNametag", "48 89 5C 24 ? 57 48 83 EC ? 48 8B D9 48 8B FA 48 8B 89 ? ? ? ? 48 85 C9 0F 84"); // CustomNameVisible
    ...
    ADD_SIG("ScreenView::setupAndRender", "E8 ? ? ? ? 48 8B 44 24 50 48 8D 4C 24 50 48 8B 80 D8 00 00 00");
    // ItemPhysics
