...
void SigInit::init2160() {
    ...
    // index is inside of it, then inside of that last func call 3arg (container specific onHover will be ContainerScreenController::_onContainerSlotHovered
    ...
    ADD_SIG("ContainerScreenController::_handleTakeAll", "E8 ? ? ? ? 49 8B ? ? C6 80 42 11 00 00");
}
...
void SigInit::init2140() {
    ...
    ADD_SIG("ContainerScreenController::_handleTakeAll", "E8 ? ? ? ? 49 8B 46 08 C6 80 B2 10 00 00 01");
}
