...
public:
    ...
    inline void begin(VertextFormat format, int reservedVerticies = 0) {
        ...
        static auto tess_begin = reinterpret_cast<tess_begin_t>(Memory::findSig(
    ...
    inline void vertex(float x, float y, float z) {
        ...
        static auto tess_vertex = reinterpret_cast<tess_vertex_t>(Memory::findSig(
    ...
    inline void color(float r, float g, float b, float a) {
        ...
        static auto tess_color = reinterpret_cast<tess_color_t>(Memory::findSig("80 b9 ? ? ? ? ? 4c 8b c1 75"));
    ...
    inline void setRotation(float angle, Vec3<float> pivot) {
        ...
        static auto tess_setRotation = reinterpret_cast<tess_setRotation_t>(Memory::findSig(
    ...
    inline void resetTransform(bool a1) {
        ...
        static auto tess_resetTransform = reinterpret_cast<tess_resetTransform_t>(Memory::findSig(
    ...
    inline void renderMeshImmediately(ScreenContext *ctx, MaterialPtr *material) {
        ...
        static auto meshHelper_renderImm = reinterpret_cast<meshHelper_renderImm_t>(Memory::findSig(
                "48 89 5C 24 ? 48 89 74 24 ? 57 48 81 EC ? ? ? ? 49 8B F8 48 8B DA 48 8B F1 80 BA ? ? ? ? ? 0F 85 ? ? ? ? 48 8D 05 ? ? ? ? 48 89 44 24 ? 48 C7 44 24 ? ? ? ? ? 0F 28 44 24 ? 66 0F 7F 44 24 ?"));
