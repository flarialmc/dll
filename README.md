...
3. **MSVC**: Ensure the MSVC compiler is installed on your system (**Clang would not work**). You can download it from [the Visual Studio downloads page](https://visualstudio.microsoft.com/downloads), then select Desktop Development with C++ in the Visual Studio installer.
